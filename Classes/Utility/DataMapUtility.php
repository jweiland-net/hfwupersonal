<?php
namespace JWeiland\Hfwupersonal\Utility;
...
class DataMapUtility {
	 ...
	 * @param \stdClass $row A single array with field_name => value pairs
	 * @return object An object of the given class
	 */
	public function mapSingleRow($className, \stdClass $row) {
		if (class_exists($className)) {
			$object = $this->objectManager->get($className);
		} else return NULL;

		// loop through all properties
		foreach (ObjectAccess::getGettableProperties($row) as $propertyName => $value) {
