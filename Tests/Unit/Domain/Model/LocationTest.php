...
/**
 * Test case for class \JWeiland\Hfwupersonal\Domain\Model\Location.
 *
...
class LocationTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \JWeiland\Hfwupersonal\Domain\Model\Location
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \JWeiland\Hfwupersonal\Domain\Model\Location();
	}
	...
	public function setRoomForRoomSetsRoom() {
		$roomFixture = new \JWeiland\Hfwupersonal\Domain\Model\Room();
